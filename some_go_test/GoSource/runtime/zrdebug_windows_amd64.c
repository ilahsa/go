...
runtime∕debug·setMaxStack(intgo in, intgo out)
{
	out = 0;
	FLUSH(&out);
#line 11 "C:\Users\ADMINI~1\AppData\Local\Temp\2\makerelease686069423\go\src\pkg\runtime\rdebug.goc"
...
runtime∕debug·setMaxThreads(intgo in, intgo out)
{
	out = 0;
	FLUSH(&out);
#line 20 "C:\Users\ADMINI~1\AppData\Local\Temp\2\makerelease686069423\go\src\pkg\runtime\rdebug.goc"
...
runtime∕debug·SetPanicOnFault(bool enabled, uint8, uint16, uint32, bool old)
{
	old = 0;
	FLUSH(&old);
#line 24 "C:\Users\ADMINI~1\AppData\Local\Temp\2\makerelease686069423\go\src\pkg\runtime\rdebug.goc"
